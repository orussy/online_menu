...
return [
    ...
    // Secret key for cache sync endpoint (change this to a secure random string)
    'sync_key' => 'sync_' . md5('change_this_secret_key_' . date('Y')),
    // Database configuration for cache storage
    'database' => [
        'host' => 'db.fr-pari1.bengt.wasmernet.com',
        'port' => 10272,
        'dbname' => 'cashe',
        'username' => '3662de1c718d8000d2c01b7c4ae5',
        'password' => '06933662-de1c-734f-8000-b5448a74da78',
        'charset' => 'utf8mb4'
    ]
];
